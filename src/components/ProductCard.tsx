...
export const ProductCard = ({ product }: ProductCardProps) => (
  <article className="w-full max-w-[384px] rounded-3xl bg-[#FFF] p-3 shadow-[0_2px_4px_rgba(0,0,0,0.08)]">
    <div className="px-1">
      <h2 className="line-clamp-1 text-[28px] font-semibold leading-[1.1] text-[#1c1c22]">{product.name}</h2>
    ...
    <div className="relative mt-4 h-[300px] w-full overflow-hidden rounded-2xl">
      ...
      />
      <div className="absolute bottom-2 left-2 rounded-full bg-white px-3 py-1 text-[20px] font-medium leading-[30px] tracking-[0px] text-[#1d1d22] [font-family:var(--font-nunito)]">
